...
# Use MLP to test
# 1. Dropout,
# 2. BatchNormalization, use before or after activation
# 3. Label(rating) normalization
...
if __name__ == '__main__':
    ...
    model = MLP(num_user=num_user, num_item=num_item, embedding_dim=embedding_dim)
